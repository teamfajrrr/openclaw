...
# Optional Render deploy config (bind 0.0.0.0:10000, auth none, allowed origins).
COPY --from=build --chown=node:node /app/deploy/render/openclaw.json /app/deploy/render/openclaw.json
